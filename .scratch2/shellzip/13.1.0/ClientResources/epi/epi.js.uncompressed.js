...
(function () {
    var routes = {
        ...
        getActionPath: function (parameters, customPath) {
            ...
            var mergedParameters = Object.assign({}, routeInfo.defaults, parameters);
        ...
        getRestPath: function (/*Object*/ parameters, /*String*/ customPath) {
            ...
            return this.getActionPath(Object.assign(parameters, { action: storeName, controller: "Stores" }), customPath);
        },
        getRouteParams: function (routeUrl, url) {
            ...
            return Object.assign(routeParams, urlParts.queryParams);
        },
...
define("epi/ModuleManager", [
    ...
    "epi/routes"
], function (array, declare, lang, Deferred, promiseAll, when, clientResourceLoader, routes) {
    ...
    var ModuleManager = declare(null, {
        ...
        _startModule: function (/*Object*/ module) {
            ...
            var self = this, runAfter = [], checkDependencies = function (dependency) {
            ...
            for (var m in this._allModules) {
                var dependant = this._allModules[m], hasDependency = array.some(dependant.moduleDependencies, checkDependencies);
                if (hasDependency) {
...
], function (config, declare, Deferred, topic, when, epi, epiDate, dependency, epiModuleManager, viewSettings) {
    return declare(null, {
        // summary:
        //		Shell bootstrapper.
        //
...
define("epi/datetime", [
...
], function (epi, dojoDate, dateStamp, locale, lang, i18n, sharedResources) {
    function _friendlyTimeDiff(fromDate, toDate) {
        var dayStr = sharedResources.text.day;
        var daysStr = sharedResources.text.days;
        var hourStr = sharedResources.text.hour;
        var hoursStr = sharedResources.text.hours;
        var minuteStr = sharedResources.text.minute;
        var minutesStr = sharedResources.text.minutes;
        var secondStr = sharedResources.text.second;
        var secondsStr = sharedResources.text.seconds;
        var result = "";
        ...
        var totalSeconds = Math.floor(totalDiff / 1000);
    ...
    return epi.datetime = {
        ...
        toUserFriendlyString: function (date, localeName, hideToday, excludeTime) {
            ...
            var today = new Date(), comparisonDate = new Date(date), selector = excludeTime ? "date" : "", datePattern = "";
        ...
        formatDateAndTime: function (date, localeName) {
            // summary:
            //      Formats a date object to a string containing both date and time.
            // date: Date
            //      The date to format.
            // localeName: String?
            //      The locale in which the date will be formatted.
            ...
            return locale.format(date, {
                datePattern: bundle["dateFormat-short"],
                timePattern: bundle["timeFormat-long"],
                locale: localeName
            });
        },
...
'epi/i18n':function(){
function tryParseResourcesFromHtml() {
    var parsedResources;
    try {
        var resourcesContainer = document.getElementById("episerver-resources-container");
        var epiResources = resourcesContainer.dataset.epiResources;
        parsedResources = JSON.parse(epiResources);
    }
    catch (ex) {
        parsedResources = {};
    }
...
define(["dojo/_base/kernel", "dojo/_base/lang"], function (dojo, lang) {
    ...
    cache = {}, parsedResources = tryParseResourcesFromHtml(), getObject = function (name, context) {
        // summary:
    ...
    }, getFromParsed = function (bundleName) {
        if (!parsedResources) {
            return null;
        }
        var properties = Array.isArray(bundleName) ? bundleName : bundleName.split(".");
    ...
    return {
        ...
        load: function (/*String*/ id, /*function*/ require, /*function*/ load) {
            ...
            id = id.toLowerCase();
            var match = nlsRe.exec(id), bundlePath = match[1] + "/", bundleName = match[5] || match[4], localeSpecified = (match[5] && match[4]), targetLocale = localeSpecified || dojo.locale, target = bundlePath + targetLocale + "/" + bundleName;
            ...
            var parsed = getFromParsed(bundleName);
            if (parsed) {
                setCache(bundleName, parsed);
                load(parsed);
                return;
            }
...
define("epi/epi", [
...
], function (dojo, lang, array, aspect) {
    var epi = dojo.getObject("epi", true);
    /*=====
    var epi = {
        // summary:
    ...
    epi.areEqual = function (first, second, compareOptions) {
        ...
        if (compareOptions && ((compareOptions & epi.compareOptions.treatFalsyAsEquals) === epi.compareOptions.treatFalsyAsEquals)) {
            if (!first && !second) {
                return true;
            }
        }
        ...
        if (((typeof first == "object") && ((typeof second == "object")))) {
            ...
            for (prop in second) {
                if (!(prop in first)) {
                    if (compareOptions && ((compareOptions & epi.compareOptions.skipEmptyProperties) === epi.compareOptions.skipEmptyProperties)) {
                        //second object has empty property and first object hasn't this property at all
                        if (!second[prop]) {
                            continue;
                        }
                    }
                    if (compareOptions && ((compareOptions & epi.compareOptions.ignoreMissingProperties) === epi.compareOptions.ignoreMissingProperties)) {
                        continue;
                    }
                    return false;
                }
            ...
            for (prop in first) {
                if (compareOptions && ((compareOptions & epi.compareOptions.skipEmptyProperties) === epi.compareOptions.skipEmptyProperties)) {
                    ...
                    if (!first[prop] && !Object.prototype.hasOwnProperty.call(second, prop)) {
                        continue;
                    }
                }
    ...
    epi.delegate = function (obj, props, aspectedMethods) {
        ...
        array.forEach(aspectedMethods, function (propName) {
            if (!Object.prototype.hasOwnProperty.call(obj, propName) || typeof obj[propName] !== "function") {
                return;
            }
