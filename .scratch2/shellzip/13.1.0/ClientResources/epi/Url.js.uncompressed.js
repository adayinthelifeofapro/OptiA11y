define("epi/Url", [
    ...
    "dojo/_base/lang",
    "dojo/io-query"
], function (declare, lang, ioQuery) {
    var module, parseMode = {
        // tags:
        //      internal
        strict: 1,
        loose: 2
    ...
    module = declare(null, {
        ...
        toString: function () {
            ...
            // tags:
            //    public
            var url = [], query = this.query, queryString;
            if (this.scheme) {
        ...
        _withQueryParseMode: function (func) {
            ...
            // tags:
            //    private
            var result, undecodable = this._undecodeable, loose = this.queryParseMode === module.parseMode.loose, originalEncode = encodeURIComponent, originalDecode = decodeURIComponent;
