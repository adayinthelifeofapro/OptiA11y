...
], function (entities, dependency, localizations) {
    return {
        // tags:
        //      public
        toUserFriendlyString: function (username, currentUsername, capitalizeUsername, keepEmptyUsername, useSubjectPronoun) {
            ...
            var emptyUsername = keepEmptyUsername ? "" : localizations.installer, youUsername = useSubjectPronoun ? localizations.yousubject : localizations.youobject, friendlyUsername = username && currentUsername.toLowerCase() === username.toLowerCase() ? youUsername : username || emptyUsername;
