    ...
    return declare([JsonRest], {
        ...
        query: function (query, options) {
            ...
            if (options.start >= 0 || options.count >= 0) {
                headers.ItemsRange = "items=" + (options.start || "0") + "-" +
            ...
            results.total = results.then(function () {
                var range = results.ioArgs.xhr.getResponseHeader("Items-Content-Range");
        ...
        executeMethod: function (method, id, data, options) {
            ...
            // tags:
            //      internal
            var hasId = id !== null && typeof id !== "undefined", url = this.target + (hasId ? id : ""), headers = options || {};
            headers.Accept = "application/javascript, application/json";
            headers["Content-Type"] = "application/json";
