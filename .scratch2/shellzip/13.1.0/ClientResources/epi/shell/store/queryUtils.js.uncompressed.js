define("epi/shell/store/queryUtils", [], function () {
    ...
    var module = {
                ...
                case "undefined":
                    filter = function (item) {
                        return !query || Object.keys(query).every(function (key) {
                            var ignoreKeys = options.ignore, comparer = options.comparers && options.comparers[key], queryValue = query[key];
        ...
        createExecuter: function (filter, sorter, start, count) {
            ...
            // returns: Function
            //		An execute function
            var begin = start || 0, end = count ? begin + count : Infinity;
