define("epi/shell/MetadataTransformer", [
    ...
    // used dynamically
    "epi-cms/contentediting/editors/JsModuleWrapperEditor"
], function (declare, lang, epiString, TypeDescriptorManager) {
    return declare(null, {
        // tags:
        //      internal
        ...
        toComponentDefinitions: function (item /*object*/, nameBase /*string*/, useDefaultValue /*Boolean*/, readOnly, convertJavascriptModules) {
            // summary:
            ...
            // convertJavascriptModules: Boolean
            //      Flag indicating if javascript modules should be wrapped with legacy editors
            // by default convert modules to module editor
            if (typeof convertJavascriptModules === "undefined") {
                convertJavascriptModules = true;
            }
            ...
            return this._getComponentDefinitions(properties, item.groups, nameBase, useDefaultValue, readOnly, modelTypeIdentifier, convertJavascriptModules);
        },
        ...
        _filterProperties: function (property) {
            var filter = this.propertyFilter, properties = property.properties;
            return filter
        ...
        _getComponentDefinitions: function (propertyDefinitions, groupDefinitions, nameBase, useDefaultValue, readOnly, modelTypeIdentifier, convertJavascriptModules) {
            var properties = lang.clone(propertyDefinitions) || [], groupContainers, groupMap = {}, defaultGroupName = epiString.pascalToCamel(this.defaultGroupName), defaultGroup, sortFn = function (item1, item2) {
            ...
            // Add default group
            groupContainers.unshift(groupMap[defaultGroupName] = defaultGroup = this._createGroupContainer({ name: defaultGroupName, title: this.defaultGroupTitle, displayUI: true }, readOnly));
            ...
            properties.forEach(function createProperties(property) {
                ...
                if (convertJavascriptModules) {
                    if (property.settings && property.settings.isJavascriptModule) {
                        property.settings.moduleType = property.uiType;
                        property.uiType = "epi-cms/contentediting/editors/JsModuleWrapperEditor";
                    }
                }
                ...
                var widgets = property.uiType
                    ...
                    : this._createParentContainer(property, nameBase, useDefaultValue, readOnly, modelTypeIdentifier, convertJavascriptModules);
        ...
        _createParentContainer: function (property, nameBase, useDefaultValue, readOnly, modelTypeIdentifier, convertJavascriptModules) {
            var baseSettings = {
                _type: "parent",
                name: nameBase + epiString.pascalToCamel(property.name),
            ...
            return {
                ...
                components: this._getComponentDefinitions(properties, property.groups, baseSettings.name + ".", useDefaultValue, readOnly, modelTypeIdentifier, convertJavascriptModules)
            };
        },
        _setTranslatedLabelAndTooltip: function (settings, modelTypeIdentifier) {
            ...
            if (!settings.label && property.caption) {
