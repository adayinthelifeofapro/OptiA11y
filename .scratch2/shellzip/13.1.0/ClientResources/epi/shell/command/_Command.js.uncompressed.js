...
declare, Stateful) {
    var _Command = declare([Stateful], {
        ...
        _showUserMessage: function (message, isError) {
            var event = new CustomEvent("setUserMessage", { detail: { text: message, isError: isError } });
            document.dispatchEvent(event);
        }
    });
    _Command.CateoryMenuWithSeparator = "menuWithSeparator";
    return _Command;
});
