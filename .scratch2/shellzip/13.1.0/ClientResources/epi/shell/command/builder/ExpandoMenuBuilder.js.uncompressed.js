...
], function (declare, lang, _CommandModelBindingMixin, ButtonBuilder, ExpandoMenuButton) {
    return declare([ButtonBuilder], {
        ...
        _create: function (/*epi/shell/command/_Command*/ command) {
            ...
            if (!hasOptions && isToggle) {
                this._expandoMenu = new this._expandoClass(this._createOptions(command));
                this._expandoMenu["class"] = this.customClass;
                return this._expandoMenu;
            }
        ...
        _createOptions: function (/*epi/shell/command/_Command*/ command) {
            ...
            return lang.mixin({
                ...
                hideSingleOption: !!command.hideSingleOption,
