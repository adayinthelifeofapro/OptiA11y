define("epi/shell/command/builder/_Builder", [
    ...
    return declare(null, {
        ...
        create: function (command, container) {
            ...
            this._addToContainer(widget, container, command);
        },
        remove: function (command, container) {
            ...
            // tags:
            //      public
            var children = this._getChildren(container), len = children.length, i = 0;
            for (; i < len; i++) {
        ...
        _getInsertIndex: function (widget, container) {
