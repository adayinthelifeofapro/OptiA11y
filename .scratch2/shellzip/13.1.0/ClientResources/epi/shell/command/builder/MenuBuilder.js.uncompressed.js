define("epi/shell/command/builder/MenuBuilder", [
    ...
    return declare([_Builder], {
        ...
        _create: function (command) {
            ...
            // tags:
            //		public
            var isToggle = typeof command.active == "boolean", isOption = lang.isArray(command.options), isPopup = "popup" in command, cls = isToggle ? this._checkedMenuItemClass : ((isOption || isPopup) ? this._popupMenuItemClass : this._menuItemClass), options = lang.mixin({ model: command }, this.itemSettings);
