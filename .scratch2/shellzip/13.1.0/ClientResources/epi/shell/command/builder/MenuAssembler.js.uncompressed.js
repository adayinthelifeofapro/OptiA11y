define("epi/shell/command/builder/MenuAssembler", [
    ...
    "dojo/aspect",
    "dojo/Stateful"
], function (declare, array, aspect, Stateful) {
    return declare([Stateful], {
        ...
        destroy: function () {
            this._commandSourceConnect && this._commandSourceConnect.remove();
        },
        build: function () {
            // summary:
        ...
        _commandSourceSetter: function (value) {
            ...
            // tags: private
            if (this.commandSource && this._commandSourceConnect) {
                ...
                this._commandSourceConnect.remove();
            ...
            if (this.commandSource) {
                ...
                this._commandSourceConnect = aspect.after(this.commandSource, "onCommandsChanged", this._commandsChanged.bind(this), true);
            }
        },
        ...
        _getBuildInfo: function (command) {
            ...
            var buildInfo, category = command.category;
