define("epi/shell/command/builder/ButtonBuilder", [
    ...
    "./_Builder",
    "./OptionsBuilderMixin"
], function (declare, lang, Menu, Button, DropDownButton, ToggleButon, ToggleCommand, _CommandModelBindingMixin, _Builder, OptionsBuilderMixin) {
    ...
    return declare([_Builder], {
        ...
        _create: function (/*epi/shell/command/_Command*/ command) {
            // tags:
            //		protected
            var hasOptions = command.get("options") instanceof Array, options = this._createOptions(command);
            if (hasOptions) {
        ...
        _createOptions: function (/*epi/shell/command/_Command*/ command) {
            ...
            if (Object.prototype.hasOwnProperty.call(options, "showLabel") && !command.label) {
