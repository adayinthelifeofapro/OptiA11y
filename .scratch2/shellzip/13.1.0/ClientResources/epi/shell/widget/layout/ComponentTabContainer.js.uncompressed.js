...
define("epi/shell/widget/layout/ComponentTabContainer", [
...
], function (array, lang, declare, domStyle, domConstruct, domAttr, domClass, domGeometry, topic, when, Evented, template, TabContainer, layoutUtils, dependency, _ComponentTabController, _ComponentResizeMixin, _WidgetsInTemplateMixin, ToggleButton, ComponentChrome, _FocusableMixin, _CommandProviderMixin, RemoveCommand) {
    return declare([TabContainer, _WidgetsInTemplateMixin, _ComponentResizeMixin, _FocusableMixin, Evented, _CommandProviderMixin], {
        ...
        postCreate: function () {
            ...
            this.own(topic.subscribe("/epi/cms/action/togglecomponent", function (args) {
                if (this.key === args.key) {
                    this.set("isHidden", args.isHidden);
                }
            }.bind(this)));
        },
        ...
        _getClosedHeight: function () {
            var marginExtents = domGeometry.getMarginExtents(this.domNode).h, headerHeight = this.tablist ? domGeometry.getMarginBox(this.tablist.domNode).h : 0, splitterHeight = this._splitter ? domGeometry.getMarginBox(this._splitter.domNode).h : 0;
        ...
        onToggleComponent: function () {
            // summary:
            //    Raised when the widget is removed or added
            // tags:
            //    public callback
        },
        ...
        _setIsHiddenAttr: function (isHidden) {
            this._set("isHidden", isHidden);
            this.domNode.style.display = isHidden ? "none" : "block";
            this.layout();
            this.onToggleComponent();
        },
