...
// dojo
declare, array, string, lang, domStyle, domAttr, domClass, domGeometry, evented, 
// dijit
wai, _CssStateMixin, _TemplatedMixin, _WidgetsInTemplateMixin, _Widget, BorderContainer, 
// epi
epi, _CommandProviderMixin, GadgetAction, RemoveCommand, ComponentChrome, _ComponentResizeMixin, _ComponentSplitter, dialogService, template, 
// resources
res) {
    ...
    return declare([BorderContainer, _ComponentResizeMixin, _CssStateMixin, _CommandProviderMixin, evented], {
        ...
        _getClosedHeight: function () {
            var headerHeight = this._header ? domGeometry.getMarginBox(this._header.domNode).h : 0, splitterHeight = this._splitter ? domGeometry.getMarginBox(this._splitter.domNode).h : 0;
