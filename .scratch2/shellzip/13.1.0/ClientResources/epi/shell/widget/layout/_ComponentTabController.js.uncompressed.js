...
], function (array, declare, lang, domStyle, domAttr, domClass, Evented, template, ScrollingTabController, _WidgetsInTemplateMixin, 
//Used in template
ToggleButton) {
    return declare([ScrollingTabController, _WidgetsInTemplateMixin, Evented], {
        ...
        _replaceMenuButton: function () {
            this._menuBtn.iconNode.classList.add("dijitHidden");
            var iconEl = document.createElement("span");
            iconEl.classList.add("dijitInline", "dijitIcon", "epi-iconContextMenu");
            this._menuBtn.domNode.prepend(iconEl);
            this._menuBtn.iconNode = iconEl;
        }
    });
});
