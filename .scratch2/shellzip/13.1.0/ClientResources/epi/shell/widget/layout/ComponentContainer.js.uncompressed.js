define("epi/shell/widget/layout/ComponentContainer", [
...
], function (array, declare, lang, aspect, when, domClass, domGeometry, domStyle, GridContainer, GridContainerLite, focus, registry, dependency, _ActionProvider, ComponentSelectorDialog, _ComponentWrapper, ComponentTabContainer, resources) {
    return declare([GridContainer, _ActionProvider], {
        ...
        addChild: function (/*dijit/_Widget*/ child, /*Integer*/ column) {
            ...
            //    The widget inserted
            var gadget, definition = this._componentsController.getComponentDefinitionById(child.componentId), id = definition ? definition.id : child.componentId, unlocked = this.containerUnlocked, settings = {
                componentId: id,
                key: definition ? definition.settings.headingLocalizationKey : "",
                dndType: this.id,
            ...
            //Connect to the onToggleComponent event on the component
            this.connect(gadget, "onToggleComponent", lang.hitch(this, function () {
                this.layoutComponents();
            }));
        ...
        changeLockButtonState: function (/*Boolean*/ isUnlocked) {
            ...
            array.forEach(this.getChildren(), lang.hitch(this, function (child) {
                ...
                child.set("closable", child.get("isRemovable") && isUnlocked);
            }));
        ...
        _organizeChildrenManually: function () {
            ...
            // tags:
            //    private
            var children = GridContainerLite.superclass.getChildren.call(this), length = children.length, child;
        ...
        getActions: function () {
            ...
            // tags:
            //      protected
            var self = this, actions = this.inherited(arguments), addGadgetsMenuItem = {
                parent: "settings",
                name: "addGadgets",
