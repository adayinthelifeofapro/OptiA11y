...
], function (array, declare, lang, domGeometry, domStyle, _ScrollbarMeasurementMixin, ComponentContainer) {
    return declare([ComponentContainer, _ScrollbarMeasurementMixin], {
        ...
        layoutComponents: function () {
            ...
            var children = this.getChildren().filter(function (child) {
                return !child.isHidden || child.isHidden === false;
            });
        ...
        _layoutChildren: function (child, height, complete) {
            var children = this.getChildren(), containerHeight = domGeometry.getContentBox(this.containerNode).h;
        ...
        _onCompontentsChanged: function () {
            var children = this.getChildren(), toggleable = children.length > 1, showSplitter = children.length > 2, setDefaultStates = children.length === 1;
        ...
        _getMaxSizeChild: function () {
            ...
            // tags:
            //      private
            var children = this.getChildren(), child = children[0], sibling = children[1], childMaxSize = domGeometry.getMarginBox(child.domNode).h;
