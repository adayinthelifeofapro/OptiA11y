define("epi/shell/widget/TextWithActionLinks", [
    ...
    "dijit/focus",
    "dojox/html/entities"
], function (array, declare, event, lang, Evented, on, query, _WidgetBase, _TemplatedMixin, focusUtil, entities) {
    return declare([_WidgetBase, _TemplatedMixin, Evented], {
        ...
        postMixInProperties: function () {
            ...
            if (this.hasTextActionsIcon) {
                this.templateString = "<{0}><span class=\"epi-text-action-icon\"></span>{1}</{0}>";
            }
