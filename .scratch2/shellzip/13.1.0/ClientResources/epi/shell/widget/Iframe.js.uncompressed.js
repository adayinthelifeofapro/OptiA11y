...
// dojo
declare, lang, array, dom, domStyle, Deferred, ioQuery, on, sniff, topic, 
// dijit
_TemplatedMixin, _Widget, focus, 
// epi
epi, Url, applicationSettings, DestroyableByKey, postMessage, routes, ApplicationSettings) {
    return declare([_Widget, _TemplatedMixin, DestroyableByKey], {
        ...
        buildRendering: function () {
            ...
            this.own(on(this.iframe, "load", function () {
                this._onIframeLoad();
            }.bind(this)), postMessage.subscribe(this.name + "/site/load", function (message) {
                this._onIframeLoad(message.url);
            }.bind(this)), postMessage.subscribe(this.name + "/site/unload", function (url) {
                this._onUnload(url);
            }.bind(this)), postMessage.subscribe(this.name + "/site/mouseup", function () {
            ...
            }.bind(this)), postMessage.subscribe(this.name + "/site/properties", function (message) {
        ...
        _onIframeLoad: function (url) {
            ...
            if (isInspectable) {
                ...
                this.ownByKey("loaded", on(this.getWindow(), "unload", this._onUnload.bind(this, url)), focus.registerIframe(this.iframe), this.connect(this.getDocument(), "onmousedown", function () {
        ...
        load: function (url, parameters, mixWithExistingParams, forceReload) {
            ...
            var deferred = new Deferred(), currentUrl = new Url(this.url), newUrl = new Url(url, parameters, mixWithExistingParams), windowProtocol = window.location.protocol.replace(":", ""), protocolIsNotEqual = (newUrl.scheme === "http" && windowProtocol === "https"), doLoad = function (url, setupTimeout) {
        ...
        _calculateActualSize: function () {
            ...
            function getSize(dir) {
                if (doc && doc.body && doc.documentElement) {
                    return Math.max(doc.documentElement["client" + dir], doc.documentElement["scroll" + dir], doc.documentElement["offset" + dir], doc.body["scroll" + dir], doc.body["offset" + dir]);
                }
                return 0;
            }
