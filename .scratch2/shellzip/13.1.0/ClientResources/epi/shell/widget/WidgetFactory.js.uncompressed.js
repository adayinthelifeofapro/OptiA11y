...
], function (array, Deferred, declare, lang, win, dom, all, when, dependency) {
    return declare(null, {
        // summary:
        ...
        =====*/
        onWrapperCreated: null,
        /*=====
        onWrapperCreated: function(wrapper){
        // summary:
        //		Called when a wrapper has been created.
        //
        // wrapper: object
        //		The created wrapper
        //
        ...
        createWidgets: function (/* dijit/_Widget|DomNode|String */ root, /* Object[] */ componentsDefinition, /* bool? */ startupWidgets) {
            ...
            // tags:
            //      public
            var syntheticRoot, getDep, widgetsTypes = [], moduleStartupDeferreds = [], createWidgetsDeferred = new Deferred(), errorHandle;
        ...
        _createWidgets: function (/* dijit/_Widget|DomNode */ root, /* Object[]? */ componentsDefinition) {
            ...
            //      private
            //
            var dfd = new Deferred(), createdWidgets = [], handler = this.getHandler(root), deferreds;
            ...
            deferreds = array.map(componentsDefinition, lang.hitch(this, function (componentDefinition) {
                // init modules
                var done = new Deferred(), widgetCreated = this._createInternal(root, componentDefinition, handler);
        ...
        _createInternal: function (root, componentDefinition, handler) {
            ...
            when(handler.instantiateWidgetFunction(componentDefinition)).then(function (widget) {
                if (widget) {
                    try {
        ...
        _addDefaultHandlers: function () {
            ...
            this.addHandler("dijit/_Container", function (rootWidget, widget) {
                var wrapper = rootWidget.addChild(widget);
                if (wrapper) {
                    if (typeof this.onWrapperCreated == "function") {
