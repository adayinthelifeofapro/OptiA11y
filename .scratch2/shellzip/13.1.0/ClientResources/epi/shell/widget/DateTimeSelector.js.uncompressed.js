...
define("epi/shell/widget/DateTimeSelector", [
    ...
    return declare([_Widget, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        _getValueAttr: function () {
            ...
            return new Date(selectedDate.getFullYear(), selectedDate.getMonth(), selectedDate.getDate(), selectedTime.getHours(), selectedTime.getMinutes(), selectedTime.getSeconds(), selectedTime.getMilliseconds());
        },
