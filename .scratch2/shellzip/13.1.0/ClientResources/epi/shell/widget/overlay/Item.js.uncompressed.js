...
], function (array, declare, lang, domClass, domStyle, mouse, on, whenAll, when, _CssStateMixin, _TemplatedMixin, _Base, Target, ApplicationSettings) {
    return declare([_Base, _TemplatedMixin, _CssStateMixin], {
        ...
        postCreate: function () {
            ...
            this.own(on(this.domNode, "click", lang.hitch(this, function (e) {
                this.onClick(this, e);
            })), on(this.domNode, mouse.enter, lang.hitch(this, this.onMouseEnter)), on(this.domNode, mouse.leave, lang.hitch(this, this.onMouseLeave)));
        ...
        resize: function (size) {
            ...
            this.inherited(arguments);
            if (ApplicationSettings.limitUI === true && this.sourceItemNode) {
                var h = this.sourceItemNode.h;
                var w = this.sourceItemNode.w;
                var t = this.sourceItemNode.y;
                var l = this.sourceItemNode.l;
                domStyle.set(this.domNode, "height", Math.round(h) + "px");
                domStyle.set(this.domNode, "width", Math.round(w) + "px");
                domStyle.set(this.domNode, "top", Math.round(t) + "px");
                domStyle.set(this.domNode, "left", Math.round(l) + "px");
        ...
        transferDndControlTo: function (/*Widget*/ controller) {
            ...
            // tags:
            //      public
            var allowedDndTypes = controller.allowedDndTypes, restrictedDndTypes = controller.restrictedDndTypes, onDropData = controller.onDropData, context = controller;
