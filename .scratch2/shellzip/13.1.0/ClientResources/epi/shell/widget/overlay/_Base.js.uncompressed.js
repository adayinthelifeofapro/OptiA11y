...
], function (declare, domGeom, domConstruct, domStyle, has, _Widget, ApplicationSettings) {
    return declare([_Widget], {
        ...
        resize: function (size) {
            ...
            if (ApplicationSettings.limitUI) {
                this.updatePosition(size || this.sourceItemNode.elementPosition);
                return true;
            }
        ...
        _getPositionAttr: function () {
            ...
            var position = domGeom.position(this.sourceItemNode, false), oldPosition = this._rawPosition, isChanged, computedStyle, margin;
            if (oldPosition) {
