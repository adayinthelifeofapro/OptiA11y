...
// dojo
array, declare, Deferred, lang, aspect, domClass, 
// dijit
ContentPane, TabContainer, registry, 
// epi
dependency, ComponentContainer, TabController, _ActionConsumerWidget, dialogService, 
// resources
res, sharedResources) {
    return declare([TabContainer, _ActionConsumerWidget], {
        ...
        _changeName: function (/*dijit/_Widget*/ page, /*String*/ value) {
            ...
            if (this._isEmpty(value)) {
                ...
                if (item) {
                    ...
                    this._componentsController.saveComponents([item], function () { }, // Do nothing on success
        ...
        _changeLayout: function (/*dijit/_Widget*/ page, /*Event*/ evt) {
            ...
            // tags:
            //    private
            var numColumns = this._getNumberOfColumns(evt), item = null;
        ...
        _showRemovalConfirmationDialog: function () {
            ...
            return dialogService.confirmation({
                ...
                title: sharedResources.header.episerver
            });
        },
