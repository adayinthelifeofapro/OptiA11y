...
], function (array, declare, lang, domClass, domStyle, promiseAll, _DialogBase, _ActionConsumerWidget, Toolbar, ToolbarSet, sharedResources) {
        ...
        getActions: function () {
            ...
            if (this.defaultActionsVisible) {
                ...
                if (this.setFocusOnConfirmButton) {
                    ...
                    okButton.settings["class"] = "epi-plain-button";
