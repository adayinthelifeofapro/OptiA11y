...
], function (declare, lang, aspect, domGeom, domStyle, has, focus, DialogUnderlay, 
// Parent class and mixins
Dialog, _DialogMixin, _WidgetsInTemplateMixin, 
// Resources
localizations, template) {
    return declare([Dialog, _DialogMixin, _WidgetsInTemplateMixin], {
        ...
        _onAfterShow: function () {
            ...
            function checkSize() {
                var curPos = domGeom.position(this.domNode), oldPos = this._relativePosition;
            ...
            if (this.useGlassUnderlay) {
                ...
                if (this.content && this.content.onResizeStart && this.content.onResizeStop && !this._attachedContentResizeEvents) {
                    this.own(aspect.after(this.content, "onResizeStart", lang.hitch(this, this._createUnderlay)), aspect.after(this.content, "onResizeStop", lang.hitch(this, this._removeUnderlay)));
        ...
        _createUnderlay: function () {
            ...
            var container = this.containerNode, contentWidth = domStyle.get(container, "width");
            ...
            if (this._glassUnderlay) {
                ...
                this.own(this._glassUnderlay = new DialogUnderlay());
                this._glassUnderlay.show();
