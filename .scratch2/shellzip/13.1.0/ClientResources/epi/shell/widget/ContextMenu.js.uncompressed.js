define("epi/shell/widget/ContextMenu", [
...
], function (declare, aspect, domGeometry, Menu, popup, _CommandConsumerMixin, MenuAssembler, MenuBuilder, MenuWithSeparatorBuilder) {
    var ContextMenu;
    ...
    return ContextMenu = declare([Menu, _CommandConsumerMixin], {
        ...
        postCreate: function () {
            ...
            var defaultConfiguration = { builder: new MenuBuilder(), target: this, category: this.category }, assembler;
            var configuration = [
