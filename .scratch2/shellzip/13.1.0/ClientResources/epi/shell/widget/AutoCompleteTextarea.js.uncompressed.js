define("epi/shell/widget/AutoCompleteTextarea", [
    ...
    // Widgets in template
    "dijit/form/Textarea"
], function (declare, lang, keys, domStyle, domGeometry, _FormValueWidget, _WidgetsInTemplateMixin, _TextBoxMixin, OnDemandList, Selection, debounce, put, popup, SelectionExtensions) {
    ...
    return declare([_FormValueWidget, _WidgetsInTemplateMixin], {
        ...
        buildRendering: function () {
            ...
            this.own(textarea.on("keyup", lang.hitch(this, "_onKeyUp")), textarea.on("keydown", lang.hitch(this, "_onKeyDown")), textarea.on("change", lang.hitch(this, "_handleOnChange")), 
            // Close the popup when the widget loses focus.
            this.on("blur", this._closePopup.bind(this)), this._selectList = new SuggestionList({
                className: "epi-autocomplete-list",
                selectionMode: "single",
                renderRow: this._renderRow.bind(this)
            }, this._listNode), this._selectList.on(".dgrid-row:click", this._insertSelection.bind(this)), this._selectList.on("dgrid-refresh-complete", lang.hitch(this._selectList, "moveSelectionDown")));
        ...
        _onKeyUp: function (e) {
            ...
            var textbox = this._textArea.textbox, caretPosition = textbox.selectionStart, value = textbox.value;
            ...
            if (this._isPopupOpen) {
                var isEscape = key === keys.ESCAPE, isAtRemoved = typeof this._tagStart == "number" && value[this._tagStart] !== "@";
        ...
        _onKeyDown: function (e) {
            var selectList = this._selectList, key = e.keyCode;
            if (this._isPopupOpen) {
                switch (key) {
                    case keys.UP_ARROW:
        ...
        _insertSelection: function () {
            var textbox = this._textArea.textbox, selectList = this._selectList, selectionEnd = this._tagEnd, value = textbox.value;
        ...
        _openPopup: function () {
            ...
            // tags:
            //      private
            var selectList = this._selectList, contentBox = domGeometry.getContentBox(this.domNode), closeFunction = this._closePopup.bind(this);
