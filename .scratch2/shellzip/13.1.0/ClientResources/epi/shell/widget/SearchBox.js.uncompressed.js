...
// dojo
declare, lang, domAttr, domClass, domStyle, keys, 
// dijit
_TemplatedMixin, _Widget, _WidgetsInTemplateMixin, focusManager, TextBox, 
// dojox
htmlEntities, 
// epi
debounce, 
...
resources, sharedResources) {
    return declare([TextBox], {
        ...
        placeHolder: sharedResources.action.search,
        ...
        postCreate: function () {
            ...
            this.connect(this, "_onInput", debounce(lang.hitch(this, function (event) {
