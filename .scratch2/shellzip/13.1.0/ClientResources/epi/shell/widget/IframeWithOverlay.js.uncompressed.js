...
// Dojo
declare, lang, array, has, number, aspect, domGeom, domStyle, domConstruct, domClass, topic, 
// Dijit
_TemplatedMixin, _WidgetsInTemplateMixin, 
// EPi Framework
_ScrollbarMeasurementMixin, AutoResizingIframe, //used in template
Overlay, _LayoutWidget, 
// Resources
template) {
    return declare([_LayoutWidget, _TemplatedMixin, _WidgetsInTemplateMixin, _ScrollbarMeasurementMixin], {
        ...
        startup: function () {
            ...
            this.inherited(arguments);
            this.own(aspect.after(this.iframe, "onAfterResize", function () {
                this.emit("viewportresized");
            }.bind(this), true));
            this.own(aspect.after(this.iframe, "onElementResize", function (properties) {
                this.overlay.updateOverlayItemBoundaries(properties);
            }.bind(this), true));
            this.own(aspect.after(this.iframe, "onUnload", function (url) {
                this.resetSiteProperties();
            }.bind(this), true));
            this._setCenterViewport(this._availableViewport || this._contentBox || domGeom.getContentBox(this.containerNode), true);
        ...
        _setCenterViewport: function (availableViewport, forceIframeResize) {
            ...
            // tags:
            //      private
            var centerSize = lang.clone(this.get("centerSize")), scrollbarSize, previewPadding;
            ...
            function getSize(dimension, axis) {
                var viewport = availableViewport[dimension], center = centerSize[dimension], size = viewport > center ? (viewport - center) / 2 : 0;
        ...
        scrollIntoView: function (/* epi/shell/overlay/_Base */ overlayItem) {
            ...
            // tags:
            //    public
            var overlayItemPosition, overlap, scrollNeeded, gutter = 16;
