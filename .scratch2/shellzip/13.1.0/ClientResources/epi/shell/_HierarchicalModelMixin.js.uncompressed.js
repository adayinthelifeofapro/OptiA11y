...
define("epi/shell/_HierarchicalModelMixin", [
    ...
    "dojo/promise/all",
    "dojo/when"
], function (array, declare, lang, Deferred, all, when) {
    // summary:
    ...
    return declare([], {
        ...
        isAncestor: function (source, target) {
            ...
            // tags:
            //      public
            var sourceId = this.store.getIdentity(source), targetId = this.store.getIdentity(target), targetParentId = this.getParentIdentity(target);
        ...
        refreshAncestors: function (item, filter) {
            ...
            // tags:
            //      public
            var store = this.store, deferred = new Deferred(), refreshDeferreds = [], refreshed = [];
