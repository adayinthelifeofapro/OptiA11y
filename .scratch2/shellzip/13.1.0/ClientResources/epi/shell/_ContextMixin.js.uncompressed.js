define("epi/shell/_ContextMixin", [
    ...
    "dojo/topic",
    "dijit/Destroyable"
], function (declare, lang, Deferred, topic, Destroyable) {
    return declare([Destroyable], {
        ...
        constructor: function (options) {
            ...
            this.own(topic.subscribe("/epi/shell/context/request", lang.hitch(this, this._contextRequest)), topic.subscribe("/epi/shell/context/changed", lang.hitch(this, this._contextChanged)), topic.subscribe("/epi/shell/context/updated", lang.hitch(this, this._contextUpdated)), topic.subscribe("/epi/shell/context/requestfailed", lang.hitch(this, this._contextFailed)), initHandle = topic.subscribe("/epi/shell/context/current", lang.hitch(this, setupCurrentContext)));
        ...
        _contextChanged: function (ctx, callerData) {
            ...
            if (typeof window.epi.updateViewMode === "function") {
                window.epi.updateViewMode(ctx);
            }
        },
