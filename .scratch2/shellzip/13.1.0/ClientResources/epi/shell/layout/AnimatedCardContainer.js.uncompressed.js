define("epi/shell/layout/AnimatedCardContainer", [
    ...
    "dgrid/util/has-css3"
], function (declare, lang, fx, aspect, has, on, domClass, domStyle, domGeometry, Deferred, query, when, _TemplatedMixin, StackContainer, hasCss3) {
    return declare([StackContainer, _TemplatedMixin], {
        ...
        _transition: function (newWidget, oldWidget, animate) {
            ...
            if (animate && oldWidget) {
                ...
                when(this._executeTransition(newWidget, this.cssClasses.secondary), 
                // transition was done
                ...
                if (this.selectedPreviousChild === newWidget) {
                    ...
                    // try to execute the transition
                    when(this._executeTransition(this.selectedChildWidget, this.cssClasses.secondaryOut), 
                    // transition was done
                    lang.hitch(this, function (widget) {
