define("epi/shell/dnd/_MarkerSource", [
    ...
    "dojo/dom-geometry",
    "dojo/dom-style"
], function (array, declare, has, Manager, Source, domClass, domConstruct, domGeom, domStyle) {
    return declare(null, {
        // summary:
        ...
        _calculateCurrent: function (point) {
            ...
            var points = [], current, minDistance;
            ...
            this.getAllNodes().forEach(function (node) {
                ...
                if (this.horizontal) {
                    ...
                    points.push({ node: node, before: true, x: pos.x, y: pos.yCentered }, { node: node, before: false, x: pos.x2, y: pos.yCentered });
                }
                else {
                    // put measuring points in centered top and bottom
                    points.push({ node: node, before: true, x: pos.xCentered, y: pos.y }, { node: node, before: false, x: pos.xCentered, y: pos.y2 });
                }
            }, this);
        ...
        _markTargetAnchor: function (before) {
            ...
            var targetNotInSelection = true, siblingNotInSelection = true;
        ...
        _positionMarker: function (enable) {
            var markerNode = this._markerNode, anchorPos, siblingAnchorPos, boxPos, style, top, left, height, width, gap = -1;
            if (enable) {
