define("epi/shell/dnd/Avatar", [
    ...
    "dojo/dnd/common",
    "dojox/html/entities"
], function (declare, win, domClass, domConstruct, domAttr, registry, common, entities) {
    return declare(null, {
        // summary:
        ...
        construct: function () {
            ...
            }), source = this.manager.source, node, outerb = domConstruct.create("tbody", null, a), outertr = domConstruct.create("tr", null, outerb), outertd = domConstruct.create("td", null, outertr), k = Math.min(5, this.manager.nodes.length), i = 0, containerdiv = domConstruct.create("div", null, outertd), div = domConstruct.create("div", null, containerdiv), overlayDiv = domConstruct.create("div", null, containerdiv), innertable = domConstruct.create("table", null, div), b = domConstruct.create("tbody", null, innertable);
