...
public sealed class AriaRequiredChildrenRuleTests
{
    private readonly AriaRequiredChildrenRule _rule = new();
    ...
    [Fact]
    public void MissingRequiredOwnedElement_IsFail()
    {
        var fragment = new AriaSemanticsFragment(
            TestLocations.OnMainBody(), "div", "list",
            MissingRequiredOwnedElementDescription: "listitem",
    ...
    [Fact]
    public void NoMissingOwnedElement_ProducesNoFindings()
    {
        var fragment = new AriaSemanticsFragment(
            TestLocations.OnMainBody(), "div", "list",
