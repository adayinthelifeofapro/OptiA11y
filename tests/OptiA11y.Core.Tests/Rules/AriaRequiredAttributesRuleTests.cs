...
public sealed class AriaRequiredAttributesRuleTests
{
    private readonly AriaRequiredAttributesRule _rule = new();
    ...
    [Fact]
    public void MissingRequiredAttribute_IsFail()
    {
        var fragment = new AriaSemanticsFragment(
            TestLocations.OnMainBody(), "div", "checkbox",
            MissingRequiredOwnedElementDescription: null,
            MissingRequiredAttributes: new[] { "aria-checked" },
    ...
    [Fact]
    public void NoMissingAttributes_ProducesNoFindings()
    {
        var fragment = new AriaSemanticsFragment(
            TestLocations.OnMainBody(), "div", "checkbox",
            MissingRequiredOwnedElementDescription: null,
